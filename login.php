...
<head>
    ...
    <link rel="stylesheet" href="admin_abastecimento/css/style.css">
</head>
<body>
    <div class="login-wrapper">
        <div class="login-logo">
            <img src="admin_abastecimento/assets/QR.png" alt="QR Combustível" onerror="this.style.display='none'">
        </div>
