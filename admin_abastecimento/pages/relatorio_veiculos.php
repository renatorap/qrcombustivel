...
$accessControl->requerPermissao('veiculo', 'acessar');
?>
<!DOCTYPE html>
<html lang="pt-BR">
<head>
    ...
    <title>Relatório de Veículos - QR Combustível</title>
...
<body>
    ...
    <div class="main-content veiculo">
        <div class="page-title">
            <span><i class="fas fa-car"></i> Relatório de Veículos</span>
        </div>
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group" style="position: relative;">
                            ...
                            <input type="text" class="form-control" id="filtroPlaca" placeholder="ABC-1234" autocomplete="off">
                            <div id="placaAutocomplete" class="autocomplete-dropdown"></div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="filtroSetor">Setor(es)</label>
                            <select class="form-select" id="filtroSetor" multiple size="5">
                                <option value="">Todos</option>
                            </select>
                            <small class="text-muted">Ctrl+clique para selecionar múltiplos</small>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
            ...
            <div class="action-buttons no-print">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="#" onclick="ordenar('placa')">Por Placa</a></li>
                        <li><a class="dropdown-item" href="#" onclick="ordenar('modelo')">Por Modelo</a></li>
                        <li><a class="dropdown-item" href="#" onclick="ordenar('marca')">Por Marca</a></li>
                        <li><a class="dropdown-item" href="#" onclick="ordenar('setor')">Por Setor</a></li>
                    </ul>
                </div>
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a class="dropdown-item" href="#" onclick="agrupar('setor')">Por Setor</a></li>
    ...
    <script src="../js/relatorio_veiculos.js"></script>
</body>
</html>
