...
<head>
    ...
    <title>Relatório de QR Codes - Veículos</title>
    ...
    <style>
        ...
        .veiculo-card input[type="checkbox"] {
            width: 20px;
            height: 20px;
            cursor: pointer;
        }
...
<body>
    ...
    <div class="main-content">
        <div class="page-title">
            <span><i class="fas fa-qrcode"></i> Relatório de QR Codes - Veículos</span>
        </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="filtroPlaca" placeholder="ABC-1234">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="filtroModelo">Modelo</label>
                                <input type="text" class="form-control" id="filtroModelo" placeholder="Digite o modelo...">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
            ...
            <div class="col-md-3">
                ...
                <div class="selection-summary">
                    ...
                    <div class="alert alert-info mt-3 mb-0" style="font-size: 0.85em;">
                        ...
                        <small>Clique nos cards para selecionar/desselecionar veículos</small>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script src="../js/relatorio_veiculo_qrcode.js"></script>
</body>
</html>
